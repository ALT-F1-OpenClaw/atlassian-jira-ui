...
5. Run tests: `cd frontend && npm test -- --run` (unit) / `npx playwright test` (E2E) / `cd backend && python -m pytest tests/ -v` (backend)
...
- 12 auto-generated screenshots in `docs/APP_SCREENSHOTS.md`
